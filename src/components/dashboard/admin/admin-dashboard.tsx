...
import { mockDonations, mockUsers } from "@/lib/placeholder-data";
import StatCard from "@/components/shared/stat-card";
import { BarChart3, Users, Package, HandHeart } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <StatCard
          ...
          description={`${Math.round((completedDonations / totalDonations) * 100)}% of donations completed.`}
        />
      </div>
